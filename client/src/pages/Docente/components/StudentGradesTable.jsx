const StudentGradesTable = ({ students, isRegistering, activateRegister, cancelRegister, handleGradeChange, handleSaveGrades }) => {
  return (
    <div>
      {/* Header */}
      ...
      <table className="w-full table-fixed">
        ...
        <tbody>
          {
            students.map(({ idEstudiante, nombreCompleto, calificacion }) => (
              <tr className="odd:bg-white-2 even:bg-white-1" key={idEstudiante}>
                ...
                <td className="pt-6 pb-2 ">
                  <button className="py-2 px-6 rounded-lg hover:bg-brand-secondary">
